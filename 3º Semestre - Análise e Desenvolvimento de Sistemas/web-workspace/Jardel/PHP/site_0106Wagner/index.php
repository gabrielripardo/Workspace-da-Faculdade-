        ...
        <nav class="navbar navbar-inverse navbar-static-top" role="navigation">
          <div class="container">
            <div class="navbar-header">
              <a class="navbar-brand" href="index.php">SisPedidos</a>
            </div>
		  ...
		  Cliente <b class="caret"></b></a>
                  <ul class="dropdown-menu">
                    <li><a href="index.php?pagina=inserir_cliente.php">Cadastrar Cliente</a></li>
		  ...
		  Produto <b class="caret"></b></a>
                  <ul class="dropdown-menu">
                    <li><a href="index.php?pagina=inserir_produto.php">Cadastrar Produto</a></li>
                    <li><a href="index.php?pagina=listar_produto.php">Listar Produto</a></li>
                  </ul>
                </li>
